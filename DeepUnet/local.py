...
def resume(model, optimizer, scheduler):
...
def _train(model, args):
    ...
    epoch = 1
    if args.resume: epoch = resume(model, optimizer, scheduler)
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='DeepUnet', choices=['MIMO-UNet', 'MIMO-UNetPlus', 'MIMO-UNetRRDB', 'MIMO-UNetRRDBEnhanced'], type=str)
    ...
    parser.add_argument('--model_save_dir', type=str, default='/data/juicefs_hz_cv_v2/11145199/deblur/results/0120')
    parser.add_argument('--result_dir', type=str, default='/data/juicefs_hz_cv_v2/11145199/deblur/results/0120')
    parser.add_argument('--mode', default='train', choices=['train', 'test'], type=str)

    # Train
    parser.add_argument('--batch_size', type=int, default=4)
    parser.add_argument('--train_count', type=int, default=256)

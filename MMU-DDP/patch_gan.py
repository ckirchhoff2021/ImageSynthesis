...
def _train(model, args):
    ...
    ####horovod
    dataloader, train_sampler = train_dataloader(args.data_dir, args.train_file, args.train_count, args.batch_size, args.num_worker, distributed=True, crop_size=512)

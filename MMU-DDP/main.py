...
# from trainx import _train
# from trainy import _train
# from trains import _train
# from train import _train
# from train_gans import _train
# from patch_gan import _train
# from m4su_train import _train

from train_gradient import _train
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--model_name', default='MIMO-UNet', choices=['MIMO-UNet', 'MIMO-UNetPlus', 'MIMO-UNetRRDB', 'MIMO-UNetRRDBEnhanced', 'MIMO-UNetFFT', 'GradientDeblurGAN', 'MS4UNet'], type=str)
    parser.add_argument('--data_dir', type=str, default='/data/juicefs_hz_cv_v3/11145199/datas/')
    ...
    parser.add_argument('--resume', type=str, default='/data/juicefs_hz_cv_v2/11145199/deblur/results/GANs/0119/GradientDeblurGAN/weights/model_150.pkl')

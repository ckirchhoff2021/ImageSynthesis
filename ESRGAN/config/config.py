...
parser.add_argument('--epoch', type=int, default=99, help='epochs in current train')
parser.add_argument('--checkpoint_dir', default='/data/juicefs_hz_cv_v2/11145199/deblur/results/esrgan', help="path to saved models (to continue training)")
parser.add_argument('--sample_dir', default='/data/juicefs_hz_cv_v2/11145199/deblur/results/esrgan/samples', help='folder to output images and model checkpoints')

...
class TrainOptions():
    def __init__(self):
        ...
        parser.add_argument('--resume', type=str, default='/data/juicefs_hz_cv_v3/11145199/pretrained/stylegan/latest.pth')
        parser.add_argument('--det', type=str, default='/data/juicefs_hz_cv_v2/11145199/face/ffhq')
